...
public class Move {
	...
	private Position to;
	/**
	 * When a pawn reaches the eighth rank, it can be promoted to another piece
	 * kind. promoteToPiece is null if no promotion is made. See
	...
	public String toString() {
		return from
				+ "->"
				+ to
				+ (promoteToPiece == null ? "" : " (promoting to "
						+ promoteToPiece + ")");
	}
